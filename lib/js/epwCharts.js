...
var _utciCatNames = ['Extreme Cold','V. Strong Cold','Strong Cold','Moderate Cold','Slight Cold',
                     'No Thermal Stress','Moderate Heat','Strong Heat','V. Strong Heat','Extreme Heat'];
...
function epwValueFilter(epw) {
    ...
    var utciCatLabels = ['Extreme Cold','V. Strong Cold','Strong Cold','Moderate Cold','Slight Cold','No Thermal Stress','Moderate Heat','Strong Heat','V. Strong Heat','Extreme Heat'];
