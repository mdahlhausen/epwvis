...
function epwValueFilter(epw) {
    ...
    var vfVarList = [
        ...
        { divId: 'sky-cover-chart',                   chartIdx: 12, label: 'Total Sky Cover',              defaultOn: false },
        { divId: 'opaque-sky-cover-chart',            chartIdx: 13, label: 'Opaque Sky Cover',             defaultOn: false },
        { divId: 'visibility-chart',                  chartIdx: 14, label: 'Visibility',                   defaultOn: false },
        { divId: 'ceiling-height-chart',              chartIdx: 15, label: 'Ceiling Height',               defaultOn: false },
        { divId: 'precipitable-water-chart',          chartIdx: 16, label: 'Precipitable Water',           defaultOn: false },
        { divId: 'aerosol-optical-depth-chart',       chartIdx: 17, label: 'Aerosol Optical Depth',        defaultOn: false },
        { divId: 'snow-depth-chart',                  chartIdx: 18, label: 'Snow Depth',                   defaultOn: false },
        { divId: 'days-since-last-snowfall-chart',    chartIdx: 19, label: 'Days Since Last Snowfall',     defaultOn: false },
        { divId: 'albedo-chart',                      chartIdx: 20, label: 'Albedo',                       defaultOn: false },
        { divId: 'liquid-precip-depth-chart',         chartIdx: 21, label: 'Liquid Precip. Depth',         defaultOn: false },
        { divId: 'liquid-precip-qty-chart',           chartIdx: 22, label: 'Liquid Precip. Quantity',      defaultOn: false },
        { divId: 'pressure-chart',                    chartIdx: 23, label: 'Station Pressure',             defaultOn: false },
        { divId: 'pv-ac-chart',                       chartIdx: 24, label: 'PV AC Output',                 defaultOn: false }
    ];
