...
function epwValueFilter(epw) {
	...
	if (unitSystem == "IP") {
		dryBulbTemperatures = dryBulbTemperature.group(function(d) { return Math.floor(d / 2) * 2; });
		dewPointTemperatures = dewPointTemperature.group(function(d) { return Math.floor(d / 2) * 2; });
	} else {
