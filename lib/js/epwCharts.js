	  ...
	  .enter().append("rect")
		...
		.on('mouseover', function(d) {
			...
			tt.innerHTML = '<strong>' + mName + ' ' + d.day + '</strong>&nbsp;&nbsp;' + hLabel
				+ '<br>' + (typeof d.value === 'number' ? d.value.toFixed(1) : d.value) + '\u00A0' + params.unit;
        ...
        dotsG.selectAll('circle')
          ...
          .enter().append('circle')
            ...
            .on('mouseover', function(d) {
                ...
                tt.innerHTML = '<strong>' + mName + ' ' + d.day + '</strong>&nbsp;&nbsp;' + hLabel
                    + '<br>' + xVd.label + ': ' + d.xv.toFixed(2) + '\u00A0' + xVd.unit
                    + '<br>' + yVd.label + ': ' + d.yv.toFixed(2) + '\u00A0' + yVd.unit;
                tt.style.display = 'block';
                tt.style.left = (d3.event.clientX + 12) + 'px';
                tt.style.top  = (d3.event.clientY + 14) + 'px';
            })
  ...
  function draw(activeData) {
    ...
    refDefs.forEach(function(r) {
      ...
      grp.append('text')
          ...
          .text(r.label + ': ' + (isNaN(val) ? '-' : val.toFixed(1) + ' ' + getUnit(vDef)));
    });
        ...
        .on('mousemove', function() {
          ...
          tooltip
              ...
              .html('Rank: ' + (rank + 1) + ' of ' + allN + '<br/>' +
                    vDef.label + ': <b>' + d[varId].toFixed(2) + ' ' + getUnit(vDef) + '</b>');
        })
        .on('mouseout', function() {
