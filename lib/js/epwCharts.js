...
function epwHeatmapCharts(epw) {
    ...
    // Ensure any newly-added entries are present
...
function epwScatterChart(epw) {
    ...
    var varDefs = [
        ...
        { id: 'solarAltitude',              label: 'Solar Altitude',             unit: '°',
          getVal: function(d) { var sp = window._solarPositions; return sp ? sp.altitude[d.index] : null; } },
        { id: 'solarAzimuth',               label: 'Solar Azimuth',              unit: '°',
          getVal: function(d) { var sp = window._solarPositions; return sp ? sp.azimuth[d.index]  : null; } }
    ];
...
function epwTabularData(epw) {
    ...
    var varDefs = [
        ...
        { id: 'solarAltitude',              label: 'Solar Altitude',            unit: '°',                             isSolar: true  },
        { id: 'solarAzimuth',               label: 'Solar Azimuth',             unit: '°',                             isSolar: false }
    ];
...
function epwDurationCurve(epw) {
  ...
  var varDefs = [
    ...
    { id: 'pvAC',                       label: 'PV AC Output',                 unitIP: 'kWh',    unitSI: 'kWh',
      fmt: function(v) { return Number(v).toPrecision(2); } },
    { id: 'solarAltitude',              label: 'Solar Altitude',               unitIP: '°',      unitSI: '°'      },
    { id: 'solarAzimuth',               label: 'Solar Azimuth',                unitIP: '°',      unitSI: '°'      }
  ];
...
function epwSunChart(epw) {
  ...
  var varDefs = [
    { id: 'none',                        label: 'None (sun position only)',   unit: '' },
    { id: 'dryBulbTemperature',          label: 'Dry Bulb Temperature',       unit: isIP ? '°F' : '°C'        },
    { id: 'dewPointTemperature',         label: 'Dew Point Temperature',      unit: isIP ? '°F' : '°C'        },
    { id: 'wetBulbTemperature',          label: 'Wet Bulb Temperature',       unit: isIP ? '°F' : '°C'        },
    { id: 'relativeHumidity',            label: 'Relative Humidity',          unit: '%'                        },
        ...
        svg.append('circle')
            ...
            .on('mouseover', function() {
              ...
              if (useVar && d[varId] !== null && isFinite(d[varId])) {
                content += '<br>' + vDef.label + ': ' + d[varId].toFixed(1) + (vDef.unit ? ' ' + vDef.unit : '');
              }
    ...
    if (useVar && colorScale) {
      ...
      for (var ti = 0; ti <= nSteps; ti++) {
        ...
        svg.append('text')
            ...
            .style('font-size', '10px').attr('fill', '#333').text(tv.toFixed(1));
      }
      svg.append('text')
