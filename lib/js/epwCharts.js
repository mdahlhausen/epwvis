...
function epwValueFilter(epw) {
    ...
    // Wind direction dimension (16 compass sectors, 22.5° each)
    var windDirDim = xfilter.dimension(function(d) {
        var dir = +d.windDirection;
        if (!isFinite(dir) || dir > 380) dir = 0;
        return Math.round(dir / 22.5) % 16;
    });
    var windDirGroup = windDirDim.group(Math.floor);
